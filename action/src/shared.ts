...
export const DEFAULT_CONTROL_PLANE_BASE_URL =
  "https://ghapp-control-plane-35h6b4wbbq-uc.a.run.app";
...
export function getState(name: string): string | null {
...
export function readOptionalInputControlPlaneBaseUrl(): string {
...
export function readActionRepository(): string {
...
export function readActionRef(): string {
...
export function readOptionalInputAgentVersion(): string {
